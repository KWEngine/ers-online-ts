        ...
        if(header != null)
        {
            ...
            if(headerCenter != null)
            {
                ...
                */
                ...
                if(HelperGeneral.isMobileDevice() && userAgent.match(/iPhone/i) == null && userAgent.match(/iPad/i) == null)
                {
    ...
    public async showInfoInfo(innerHTMLSource:string, specialMode:string = "")
    {
        ...
        else
        {
            ...
            if(specialMode == "share")
            {
                ...
                html = '<p id="p-share">Teile Deine aktuelle Position via QR-Code oder als Link:</p>' + html + '<br /><p id="p-share"><a href="' + loc + '">Link zur aktuellen Position</a></p>';
            }
